...
=======
        $password = ""; 
        $dbname = "dogbreeder_db";
>>>>>>> b2640895fb6c90f4ed5e3a85449dc28ea3211e27
        ...
        if (mysqli_num_rows($result) == 0) {
            echo "<p style='font-size: 1.3rem; text-align: center; position: relative; top: 150px;'>Reviews will appear here</p>";
        } else {
            $counter = 0;
                ...
                <div class="col-md-6">
                    <div class="card post-card mb-4 border border-3"> 
                        ...
                        <?php
                            ...
                            ?>
                     <img src="<?php echo  substr($row['user_profile_image'], 4,$imgPathLength) ?>" alt="Profile Image" style="position: relative; right: 10px; bottom: 5px;" class="profile-image rounded-circle w-6 h-6">
