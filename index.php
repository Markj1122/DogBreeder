       ...
       <h1 class="mx-4">Featured</h1>
         ...
         <div class="row my-2">
          ...
          <div class="col-md-6">
            <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
              <div class="col p-4 d-flex flex-column position-static">
                ...
                <h3 class="mb-0">Featured Puppies</h3>
                <div class="mb-1 text-body-secondary">Nov 12</div>
                <p class="card-text mb-auto">This is a wider card with supporting text below as a natural lead-in to additional content.</p>
                <a href="dog-type.php?type=puppy" class="stretched-link" style="text-decoration:none;">View More...</a>
              </div>
          ...
          <div class="col-md-6">
            <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
              <div class="col p-4 d-flex flex-column position-static">
                <strong class="d-inline-block mb-2 text-success">Dogs</strong>
                <h3 class="mb-0">Featured Dog</h3>
                <div class="mb-1 text-body-secondary">Nov 11</div>
                <p class="mb-auto">This is a wider card with supporting text below as a natural lead-in to additional content.</p>
                <a href="dog-type.php?type=adult" class="stretched-link" style="text-decoration:none;">View More...</a>
              </div>
              <div class="col-lg-5 col-12 d-lg-block">
