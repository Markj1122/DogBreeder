...
if (isset($_POST['op']) && isset($_POST['np']) && isset($_POST['confirm_password'])) {
    ...
    if ($new_password !== $confirm_password) {
        ...
        // Assuming you have a id to identify the User whose password you want to update.
        $id = $_SESSION['id']; // You need to retrieve the userID from the session or another source.
