...
if (isset($_POST['op']) && isset($_POST['np']) && isset($_POST['confirm_password'])) {
    ...
    if ($new_password !== $confirm_password) {
        ...
        // Assuming you have a id to identify the breeder whose password you want to update.
        $id = $_SESSION['user_id']; // You need to retrieve the breeder ID from the session or another source.
        ...
        if ($result->num_rows === 1) {
            ...
            $_SESSION['error'] = "Breeder not found";
        }
