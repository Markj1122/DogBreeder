...
?>
                                ...
                                <form class="card" method="post" action="update-account.php" enctype="multipart/form-data">
                                                ...
                                                <div class="col">
                                                   <div class="upload">
                                                      <div class="image-wrapper">
                                                         <img id="preview" src="<?php echo $row['profile_image']; ?>" width="100" height="100" alt="Profile Image">
                                                         <div class="round">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" name="fname" id="fname" value="<?php echo $row['fname']; ?>" readonly>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label"><b>Lastname</b></label>
                                                        <input class="form-control" name="lname" id="lname" value="<?php echo $row['lname']; ?>" readonly>
                                                    </div>

                                                    <div class="mb-3 input-with-icon">
                                                        <label class="form-label"><b>Email Address</b></label>
                                                        <div class="input-group">
                                                            <input class="form-control" type="email" name="new_email" id="new_email" value="<?php echo $row['email']; ?>">
                                    ...
                                    <div class="card-footer text-end">
                                        ...
                                        <a href="dashboard.php" class="btn btn-secondary d-sm-inline-block">Cancel</a>
                                    </div>
                                </form>
                            </div>
                        </div>
