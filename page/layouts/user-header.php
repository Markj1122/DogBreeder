...
<?php
// Assuming you have a way to identify the logged-in user, let's say you have their ID in a variable called $loggedInUserId
$loggedInUerId = $_SESSION['user_id']; // Replace this with your actual session variable

include ('../../page/router/config.php');

// Modify the SQL query to fetch data for the logged-in user
$sql = "SELECT * FROM `user` WHERE user_id = $loggedInUerId";
...
if ($row = $query->fetch_assoc()) {
    ...
    echo " <div class='mt-1 small text-muted'>".$row['user_role']."</div>";
    //echo "<div class='count-breeder hidden'></div>";
    echo "</div>";
    echo "</a>";
}
?>
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                       <a href="../../accounts/user/track-purchase.php" class="dropdown-item"><i class="fa-solid fa-magnifying-glass"></i>&nbsp; Track Purchase</a>
                       <a href="../../accounts/user/upgrade-account.php" class="dropdown-item"><i class="fa-solid fa-user-shield"></i>&nbsp;Upgrade Account</a>
                       <a href="../../accounts/user/edit-account.php" class="dropdown-item"><i class="fa-solid fa-user"></i>&nbsp; Accounts</a>
                       <a href="../../accounts/user/change-password.php" class="dropdown-item"><i class="fa-solid fa-gear"></i>&nbsp; Settings</a>
          ...
          <div class="collapse navbar-collapse" id="navbar-menu">
            <div class="d-flex flex-column flex-md-row flex-fill align-items-stretch align-items-md-center">
              <ul class="navbar-nav"> 
                <li class="nav-item">
                  <a class="nav-link" href="../../accounts/user/post-feed.php" >
              ...
              <form action="../../accounts/user-1/search-post.php" method="GET" class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-4 search-bar"  role="search">
